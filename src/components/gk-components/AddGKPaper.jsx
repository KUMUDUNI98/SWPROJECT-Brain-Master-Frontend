...
class AddGkPaper extends Component {
    ...
    addPaper = (e) => {
        e.preventDefault();//ignore refrese,we used form & this time event access and prevent
            ...
            if (json.error) {
                ...
                fetch(api + "/paper2/" + this.state.paper_name)
                    ...
                    .then((json) => {
                        ...
                        setTimeout(//heppend work after the 2ms
                            function () {
                                this.setState({
                                    redirect: "/add_gk_q",
                                });
    ...
    render() {
        // let {userList} =for prevet this.state;
